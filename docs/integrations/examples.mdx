...
**Artifacts:**
- Architecture diagram (app → Redis → DB)
...
**PR Comment:**
```markdown
🎓 Gap Detected: Coverage dropped 15% on UserService.ts
📚 Course: Unit Testing Best Practices (7 mins)
...
**PR Comment:**
```markdown
🎓 Gap Detected: Function complexity >15 (cyclomatic)
📚 Course: Refactoring Complex Functions (10 mins)
...
<Card title="Try It Yourself" icon="rocket" href="/quickstart">
  Connect GitHub and learn from your next PR →
</Card>